<template>
  <div class="page">
    ...
    <el-card>
      ...
      <div class="actions">
        <el-button type="primary" @click="$router.push('/patient/orders/create')">继续下单</el-button>
        <el-button @click="$router.push('/patient/orders')">查看订单</el-button>
        <el-button @click="$router.push('/patient/review')">我的评价</el-button>
      </div>
    </el-card>
...
async function saveUsername() {
  ...
  try {
    ...
    await auth.updateUsername(name, 'patient')
...
async function savePhone() {
  ...
  try {
    ...
    await auth.updatePhone(newPhone, 'patient')
...
function handleAvatarFileChange(event) {
  ...
  reader.onload = () => {
    auth.updateAvatar(String(reader.result || ''), 'patient')
